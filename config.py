...
PAID_PRICE_VIDEO_USDT = "0"      # per-call price: video_context ("0" = free, route not gated)
...
# --- video_context (why a video blew up) ---
PAID_VIDEO_PATH = "/paid/video_context"
...
# --- rising_channels (niche momentum radar) ---
PAID_RADAR_PATH = "/paid/rising_channels"
RADAR_SEARCH_RESULTS = 50
RADAR_DEEP_CHANNELS = 15
RADAR_MAX_CHANNELS = 10
RADAR_MAX_SUBS_DEFAULT = 500_000
RADAR_MAX_SUBS_MIN = 1_000
RADAR_MAX_SUBS_MAX = 10_000_000
RADAR_MIN_MOMENTUM = 1.0  # a channel only counts as rising above this multiple
RADAR_WORST_CASE_UNITS = (
    COST_SEARCH + 2 * COST_LIST + RADAR_DEEP_CHANNELS * 2 * COST_LIST
)
